...
if uploaded_file is not None:
    ...
    st.dataframe(df.style.highlight_max(color='white',axis=0),height=10,use_container_width=True)
...
st.dataframe(pd.DataFrame(emp_att[prediction]).style.highlight_max(color='white',axis=0),height=10,use_container_width=True)
...
st.dataframe(proba_df_formatted.style.highlight_max(color='white',axis=0),height=10,use_container_width=True)
